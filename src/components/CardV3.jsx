...
const CardV3 = ({ data }) => {
  return (
    <div className='card-v1 bg-[#1d1d1d] rounded'>
      <h3 className='titel-sm mb-15'>About</h3>
      <h1 className='titel mb-10'>WHERE FASHION MEETS FREEDOM</h1>
      ...
      <div className='grid grid-cols-2 gap-10 py-1'>
        <p>We believe that fashion should be an expression of individuality. We encourage creativity and originality in every item we offer, presenting customers with exclusive collections from independent designers.
          With a commitment to fostering a community of creativity and innovation,
        </p>
